	...
	private HBox addHBox() {
		...
		buttonSearch.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent event) {
				...
				if (f != null) {
					ArrayList<Note> result = new ArrayList<Note>(f.searchNotes(currentSearch));
		...
		hbox.getChildren().addAll(buttonLoad, buttonSave, searchLabel, searchTextField, buttonSearch,
				buttonClearSearch);
